...
### R-001 — Source API Schema Change
**Status:** 🟡 Monitoring  
**Owner:** Aaiyan Virji  
...
**Residual Risk:** Medium — schema changes would require manual intervention but are detectable immediately from logs.

---

### R-002 — SQLite File Corruption
**Status:** 🟢 Open  
**Owner:** Aaiyan Virji  
**Identified:** February 23, 2026  
...
**Residual Risk:** Low — full regeneration on every run means corruption is self-healing.

---

### R-003 — DQ Check Performance at Scale
**Status:** 🟢 Open  
**Owner:** Aaiyan Virji  
**Identified:** February 23, 2026  
...
**Mitigation Plan**
- Current implementation handles 5,000 rows in under 2 seconds — acceptable for portfolio scale
...
**Residual Risk:** Medium — acceptable at current scale, revisit if row limit exceeds 100k.

---

### R-004 — Scope Creep into ML Modeling
**Status:** ✅ Closed  
**Owner:** Aaiyan Virji  
**Identified:** February 23, 2026  
...
**Mitigation Plan**
- Scope explicitly defined in README — ML modeling listed as out of scope
...
### R-005 — GitHub Pages Deployment Failure
**Status:** 🟢 Open  
**Owner:** Aaiyan Virji  
**Identified:** February 23, 2026  
...
**Residual Risk:** Low — build failures are visible and fixable without data loss.

---

### R-006 — Virtual Environment Dependency Drift
**Status:** 🟢 Open  
**Owner:** Aaiyan Virji  
**Identified:** February 23, 2026  
...
**Residual Risk:** Low — easy to detect and fix by comparing pip freeze output.
...
|---------|-------------|----------|--------|
| R-001 | Source API Schema Change | High | 🟡 Monitoring |
| R-002 | SQLite File Corruption | Low | 🟢 Open |
| R-003 | DQ Check Performance at Scale | Medium | 🟢 Open |
| R-004 | Scope Creep into ML Modeling | Low | ✅ Closed |
| R-005 | GitHub Pages Deployment Failure | Medium | 🟢 Open |
| R-006 | Virtual Environment Dependency Drift | Low | 🟢 Open |